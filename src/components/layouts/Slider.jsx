         ...
         <div className="flex items-center">
          {/* slider one  */}
            <div className="bg-white p-10 rounded-4xl w-[20%]">
                ...
                <p className="text-base font-Inter my-8">Love the ease and efficiency. Awesome app. Very informative and insightful if wanting to know more about your device. The added breach check.is a great bonus. Check any email of they’ve ever been named in a data breach from years ago. Sweet tool. Love it highly recommend.</p>
                <p>Jennifer Black</p>
            </div>
         </div>
    </section>
